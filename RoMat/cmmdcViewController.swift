...
class cmmdcViewController: UIViewController, UITextFieldDelegate {
        ...
        if nr1.text != "" && nr2.text != ""
        {
            ...
            if String(a).count <= 10 && String(b).count <= 10
            {
                ...
                if a != 0 && b != 0
                {
                    ...
                    label.text = "C.M.M.D.C. = " + String(b)
                }
                else if b == 0
                {
                    label.text = "C.M.M.D.C. = " + String(a)
                }
                else if a == 0
                {
                    label.text = "C.M.M.D.C. = " + String(b)
                ...
                {
                    label.text = "C.M.M.D.C. = 0"
                }
            
                    else if String(a).count >= 10 && String(b).count <= 11
                {
                        label.text = "Numarul 1 este prea mare."
                }
            else if String(a).count <= 11 && String(b).count >= 10
                {
